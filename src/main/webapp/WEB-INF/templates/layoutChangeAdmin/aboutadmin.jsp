...
<%--                        <div class="row">--%>
<%--&lt;%&ndash;                            <div class="col-lg-3 col-md-6 col-6 ml-auto">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <h5>12<br><small>Files</small></h5>&ndash;%&gt;--%>
<%--&lt;%&ndash;                            </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                            <div class="col-lg-4 col-md-6 col-6 ml-auto mr-auto">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <h5>2GB<br><small>Used</small></h5>&ndash;%&gt;--%>
<%--&lt;%&ndash;                            </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                            <div class="col-lg-3 mr-auto">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <h5>24,6$<br><small>Spent</small></h5>&ndash;%&gt;--%>
<%--&lt;%&ndash;                            </div>&ndash;%&gt;--%>
<%--                        </div>--%>
<%--                    </div>--%>
<%--                </div>--%>
                        ...
                        <div class="row">
                            <div class="col-md-5 pr-1">
                                <div class="form-group">
                                    <label>id</label>
                                    <form:input type="text" class="form-control" disabled="false"  placeholder="id"  path="id"/>
                                    <form:errors path="id" />
                                </div>
                            </div>
                            <div class="col-md-5 pr-1">
                            ...
                            <div class="col-md-2 pl-1">
                                <div class="form-group">
                                    <label>Admin</label>
                                    <form:input  type="text"  class="form-control" value="true"  path="admin" />

                                </div>
                                <div class="form-group">
                                    <label>Activated</label>
                                    <form:input  type="text" class="form-control" value="true"  path="activated" />
