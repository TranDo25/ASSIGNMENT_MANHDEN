                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="search" class="form-control" value="${old}" id="old" name="old" placeholder="Old password" aria-label="Recipient's username" aria-describedby="button-addon2" >
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="search" class="form-control" value="${newp}" id="newp" name="newp" placeholder="Password" aria-label="Recipient's username" aria-describedby="button-addon2" >
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
...
<%--                                        <button type="button" class="btn btn-primary btn-round " formaction="/Home/account/change/save">Update </button>--%>
                                        <button type="button" class="btn btn-warning btn-round ml-4" href="/Home/views">Cancel</button>
                                    </div>
