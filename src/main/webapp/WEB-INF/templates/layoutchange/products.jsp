...
<%--                </form>--%>
    <form class="form-inline my-2 my-lg-0 "  action="/product/search" method="post">
        ...
        <ul>
            <li><a href="/product/price/between0_50" style="color: #f33f3f"> 0-50.000 vnd</a></li>
            <li><a href="/product/price/between50_100" style="color: #f33f3f"> 50.000-100.000 vnd</a></li>
            <li><a href="/product/price/between100_150" style="color: #f33f3f"> 100.000-150.000 vnd</a></li>
            <li><a href="/product/price/between150_200" style="color: #f33f3f"> 200.000-250.000 vnd</a></li>
            <li><a href="/product/price/between200" style="color: #f33f3f"> 250.000 vnd +</a></li>
        </ul>
    </form>
            </div>
          </div>
                ...
                <div class="col-3">
                    <div class="product-item">
                        ...
                        <div class="down-content">
                            ...
                            <a class="filled-button" href="/Home/product/about/${item.id}">Detail</a>
                        </div>
